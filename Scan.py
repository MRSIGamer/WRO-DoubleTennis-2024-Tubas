...
def scan(area : str):
    ...
    while True:
        ...
        #Checks if the user want to scan the right A,B ball section
            ...
            movement.Drive_Straight_Untill_Ramping(35)
      ...
      #Checks if the user want to catch the balls in the left A,B ball section
            ...
            movement.Turn_Hiter_Back()
            movement.GyroSensor.reset()
            movement.Gyro_Straight_Move_Untill_Ramping(10)
            sleep(0.4)
            movement.Turn_Hiter_Back()
            sleep(0.4)
            movement.Drive_Straight_Degs(-20, 150)
      ...
      #Checks if the user want to catch the balls in the left A,B ball section
        ...
        #Checks if the user wants the robot to go to the middle area
            ...
            movement.Turn_Hiter_Back()
            movement.Long_Turn(10, -3)
            movement.GyroSensor.reset()
            movement.Gyro_Straight_Move_Untill_Ramping(10)
            movement.Lift_Hiter_To_Throw()
            movement.Drive_Straight_Degs(-10, 100)
            movement.Spin_90_Degrees_Right()
            movement.Drive_Untill_Stalled(-20)
            movement.Gyro_Straight_Move_Degs(10, 300)
        ...
        #checks if the user wants the robot to go to the left section in the mat
            ...
            movement.Drive_Straight_Untill_Ramping(20)
            sleep(0.4)
            movement.Turn_Hiter_Back()
            sleep(0.4)
            movement.Drive_Straight_Degs(-20, 310)
        ...
        #Checks if the user wants the robot to go to the right section of the mat
            ...
            movement.Drive_Straight_Untill_Ramping(20)
            movement.Drive_Straight_Degs(-10, 310)
        ...
        #Checks if the user wants the robot to go to the right next to home section of the mat
            ...
            sleep(0.4)
            movement.Long_Turn(10, 3)
            movement.Drive_Untill_Stalled(45)
            sleep(0.4)
            movement.Catch_Ball()
            sleep(0.5)
            movement.Drive_Straight_Degs(-20, 170)
            movement.Spin_90_Degrees_Right()
            movement.Drive_Untill_Stalled(-20)
            movement.Gyro_Straight_Move_Degs(10, 280)
            movement.Turn(10, 85)
        ...
        # Checks if the user wants the robot to go to the middle next to home section of the mat to take the purple ball
            ...
            movement.Open_Catcher()
            movement.Drive_Untill_Stalled(-20)
            movement.Gyro_Straight_Move_Degs(20, 130)
            movement.Turn_Right_Wall_90_Degrees()
            movement.Drive_Untill_Stalled(-20)
            break
        ...
        #Checks if the user wants the robot to go to the left next to home section of the mat to take the purble ball
            ...
            movement.Open_Catcher()
            movement.Drive_Untill_Stalled(-20)
            movement.Gyro_Straight_Move_Degs(20, 100)
            movement.Turn_Right_Wall_90_Degrees()
            movement.Drive_Untill_Stalled(-20)
            break
        ...
        #Checks if the user wants the robot to go to the right corner were the balls come back if they were kicked out of the game field
        elif area.lower().replace(" ", "") == "get_balls_from_the_corner":
            movement.Turn_Hiter_Back()
            movement.Long_Turn(10, -50)
            movement.Long_Turn(10, 50)
            movement.Drive_Untill_Stalled(-20)
            movement.Long_Turn(10, 85)
            movement.Drive_Untill_Stalled(25)
            movement.Catch_Ball()
            movement.Drive_Straight_Degs(-20, 340)
            movement.Turn_Left_Wall_90_Degs()
            movement.Drive_Untill_Stalled(-20)
            movement.Gyro_Straight_Move_Degs(25, 100)
            movement.Throw_Ball()
            sleep(0.9)
            movement.Drive_Untill_Stalled(-20)
            break
